// Shorts Filter for Invidious Subscriptions - Optimized
(function() {
    'use strict';
    ...
    // Cached DOM queries and optimized styles
    const SELECTORS = {
    ...
    // Use CSS classes defined in default.css
    const CSS_CLASSES = {
    ...
    // Regex for duration matching (compiled once) - videos under 1 minute
    ...
    // Optimized button text update with batch DOM operations
    ...
    function apply() {
        ...
        requestAnimationFrame(() => {
            ...
            // Process videos in batches to avoid layout thrashing
    ...
    // Optimized observer with better filtering
